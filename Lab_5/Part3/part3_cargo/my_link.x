...
PROVIDE(start0 = default_start);
PROVIDE(start1 = default_start);
PROVIDE(start2 = default_start);
PROVIDE(start3 = default_start);

PROVIDE(task0_stack_size = default_stack_size);
PROVIDE(task1_stack_size = default_stack_size);
PROVIDE(task2_stack_size = default_stack_size);
PROVIDE(task3_stack_size = default_stack_size);
